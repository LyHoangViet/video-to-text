...
def analyze_frames_with_nova(frames, prompt: str, temperature: float, top_p: float, top_k: int, max_tokens: int, region_name: str = "us-east-1"):
    """
...
def main():
    # App title
    st.title("Phân Tích Video Sản Phẩm Với Amazon Nova")
